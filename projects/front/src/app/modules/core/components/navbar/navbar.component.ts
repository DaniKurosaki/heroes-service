...
@Component({
	selector: "navbar",
	standalone: true,
	imports: [CommonModule, RouterModule, MatButtonModule, MatSlideToggleModule, MatToolbarModule],
...
export class NavbarComponent {
	...
	ngAfterViewInit() {
		...
		this.element.nativeElement.querySelector('.mdc-switch__icon--on').firstChild.setAttribute('d', defaultTheme === 'light' ? this.moon : this.sun);
		this.element.nativeElement.querySelector('.mdc-switch__icon--off').firstChild.setAttribute('d', defaultTheme === 'light' ? this.sun : this.moon);
	}
